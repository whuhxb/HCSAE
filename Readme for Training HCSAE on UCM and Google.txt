...
4. To test the once trained results for UCM and Google dataset, download the HCSAE_data.zip from https://drive.google.com/file/d/1l04T-f_pCfe1iHRRUJqtZJhwdaBccsMu/view?usp=drive_link, and run the UCMPoolTest.m or GooglePoolTest.m in the "data_already_run" folder.
