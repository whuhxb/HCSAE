...
4. To test the trained results for UCM and Google dataset, download the HCSAE_data.zip, and run the UCMPoolTest.m or GooglePoolTest.m in the "data_already_run" folder.
